...
- (void)viewDidLoad
{
    ...
    self.section0 = @"I am section 0";
    
//    NSMutableArray * displayTekst = [[NSMutableArray alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) { cell.backgroundColor = [UIColor redColor];
        cell.textLabel.text = self.section0;
